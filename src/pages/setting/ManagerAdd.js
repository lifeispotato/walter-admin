...
import "../../css/setting/ManagerAdd.css";
  ...
  return (
    <div className="admin-container">
      <div className="admin-wrap">
        <div className="admin-content-container manager-add-container">
          <div className="go-back-container" onClick={() => navigate(-1)}>
            <img src="/img/chevron-left.svg" />
            <span className="b3">뒤로가기</span>
          </div>
          <div className="manager-add-wrap">
            <span className="b1">추가하기</span>
            <div className="manager-add-input">
              ...
              <div className="form-layout form-layout-radio">
            ...
            <div className="save-btn manager-add-save">
              <button>저장하기</button>
            </div>
          </div>
        </div>

...
import "../../css/contents/ContentsAdd.css";
  ...
  return (
    <div className="admin-container">
      <div className="admin-wrap">
        <div className="admin-content-container contents-add-container">
          <div className="go-back-container" onClick={() => navigate(-1)}>
            <img src="/img/chevron-left.svg" />
            <span className="b3">뒤로가기</span>
          </div>
          <div className="contents-add-wrap">
            <span className="b1">추가하기</span>
            <div className="contents-add-input">
            ...
            <div className="save-btn contents-add-save">
              <button>등록하기</button>
            </div>
          </div>
        </div>

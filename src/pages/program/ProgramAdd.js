...
import "../../css/program/ProgramAdd.css";
  ...
  return (
    <div className="admin-container">
      <div className="admin-wrap">
        <div className="admin-content-container program-add-container">
          <div className="go-back-container" onClick={() => navigate(-1)}>
            <img src="/img/chevron-left.svg" />
            <span className="b3">뒤로가기</span>
          </div>
          <div className="program-add-wrap">
            ...
            <div className="save-btn program-add-save">
              <button>저장하기</button>
            </div>
          </div>
        </div>
